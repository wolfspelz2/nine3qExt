...
export class TestVpiResolver
{
    ...
    VpiResolver_map_galdev()
    {
        expect(new VpiResolver(new TestDataProvider_map_galdev(), new TestConfigInstance_map_galdev()).map('https://www.galactic-developments.de/')).to.equal('xmpp:d954c536629c2d729c65630963af57c119e24836@muc4.virtual-presence.org');
    }
}
