...
export class Chatout
{
    ...
    constructor(private app: ContentApp, private participant: Participant, private display: HTMLElement)
    {
        ...
        this.closeElem = <HTMLElement>$('<div class="n3q-base n3q-button n3q-button-overlay n3q-shadow" title="Close" data-translate="attr:title:Common"><span class="n3q-base n3q-button-close-small" />').get(0);
