...
export class Chatout
{
    ...
    {
        this.elem = <HTMLElement>$('<div class="n3q-div n3q-chatout" />')[0];
        ...
        var speechBubble = <HTMLElement>$('<div class="n3q-div n3q-speech n3q-shadow" />')[0];

        this.textElem = <HTMLElement>$('<p class="n3q-div n3q-text" />')[0];
