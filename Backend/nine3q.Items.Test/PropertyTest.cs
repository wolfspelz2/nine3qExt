...
namespace nine3q.Items.Test
{
    ...
    public class PropertyTest
    {
        ...
        public void Property_AreEquivalent()
        {
            ...
            Assert.IsTrue(Property.AreEquivalent(Property.Type.Item, new ItemId(1), new ItemId(1)));
            Assert.IsTrue(Property.AreEquivalent(Property.Type.Item, 1, new ItemId(1)));
            Assert.IsTrue(Property.AreEquivalent(Property.Type.Item, (long)1, new ItemId(1)));
        ...
        public void Property_AreEquivalent_not()
        {
            ...
            Assert.IsFalse(Property.AreEquivalent(Property.Type.Item, new ItemId(1), new ItemId(2)));
            Assert.IsFalse(Property.AreEquivalent(Property.Type.Item, new ItemId(1), ItemId.NoItem));
