...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.Container                             ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Generic   , Access.Owner   , Persistence.Persistent , PropertyValue.Empty , "10000000001", "Id of container item."),
