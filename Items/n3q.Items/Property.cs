...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.Width                            ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.Generic   , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "100", "Image/Animation display width."),
        [Pid.Height                           ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.Generic   , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "100", "Image/Animation display width."),
        ...
        [Pid.RezzableProxyAspect              ] = new Definition(Storage.Bool    , Type.Bool            , Use.Aspect       , Group.Aspect    , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "true", "Item is a proxy for a rezzed item."),
        ...
        [Pid.InventorySetCoordinateItem       ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "ItemId", "Item in inventory to be positioned."),
        [Pid.InventorySetCoordinateX          ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "X position in repository."),
        [Pid.InventorySetCoordinateY          ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Y position in repository."),
