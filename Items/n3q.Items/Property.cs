...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.InventorySetCoordinatesLeft      ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Left position of the repository."),
        [Pid.InventorySetCoordinatesBottom    ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Bottom distance of the repository."),
        [Pid.InventorySetCoordinatesWidth     ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Width of the repository."),
        [Pid.InventorySetCoordinatesHeight    ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Height of the repository."),
