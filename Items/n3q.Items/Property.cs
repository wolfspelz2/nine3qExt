...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.FirstOperation                 ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , "", ""),
        [Pid.Item                           ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Operation , Access.System  , Persistence.Unknown    , "1", "Passive item of item action."),
        [Pid.MetaPublicAccess               ] = new Definition(Storage.Bool    , Type.Bool            , Use.Bool         , Group.Operation , Access.System  , Persistence.Unknown    , "", "Meta property for declaring a PidSet with only this Pid as indicator for GetItemProperties for all public properties."),
        [Pid.MetaOwnerAccess                ] = new Definition(Storage.Bool    , Type.Bool            , Use.Bool         , Group.Operation , Access.System  , Persistence.Unknown    , "", "Meta property for declaring a PidSet with only this Pid as indicator for GetItemProperties for all owner properties."),
        [Pid.MetaAspectGroup                ] = new Definition(Storage.Bool    , Type.Bool            , Use.Bool         , Group.Operation , Access.System  , Persistence.Unknown    , "", "Meta property for declaring a PidSet with only this Pid as indicator for GetItemProperties for all aspect properties."),
        ...
        [Pid.RezableAspect                  ] = new Definition(Storage.Bool    , Type.Bool            , Use.Aspect       , Group.Aspect    , Access.System  , Persistence.Persistent , "true", "Item can be rezzed to room."),
        ...
        [Pid.RezableRezRoom                 ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Parameter , Access.System  , Persistence.Transient  , "room@chat.server.org", "Room to rez to by Rezable.Rez."),
        [Pid.RezableRezX                    ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , "100", "Room to rez to by Rezable.Rez."),
        [Pid.RezableRezDestination          ] = new Definition(Storage.String  , Type.String          , Use.Url          , Group.Parameter , Access.System  , Persistence.Transient  , "http://...", "Url of the room to rez to by Rezable.Rez."),
        [Pid.RezableDerezUser               ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Parameter , Access.System  , Persistence.Transient  , "{8AC310B6-4903-4BE9-AE8C-F329CABA9468}", "User to derez to by Rezable.Derez."),
        [Pid.PassiveItem                    ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Parameter , Access.System  , Persistence.Unknown    , "ItemId", "Passive item of item action."),
        [Pid.FirstApp                       ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , "------------------------------------------------------", ""),
        ...
        [Pid.TestGreeterResult              ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.Parameter , Access.System  , Persistence.Transient  , "Hello World", "Greeting result stored by Greeter before return"),
        [Pid.TestGreetedResult              ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.Parameter , Access.System  , Persistence.Transient  , "Hello World", "Greeting result stored by Greeted"),
