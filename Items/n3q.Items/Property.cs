...
namespace n3q.Items
{
    public static class Property
    {
        ...
        public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
            ...
            [Pid.Test1Aspect] = new Definition(Pid.Test1Aspect, Type.Bool, Use.Bool, Group.Aspect, Access.System, Persistence.Fixed, "true", "Test aspect flag"),
            [Pid.Test2Aspect] = new Definition(Pid.Test2Aspect, Type.Bool, Use.Bool, Group.Aspect, Access.System, Persistence.Fixed, "true", "Test aspect flag"),
