...
namespace n3q.Items
{
    public static class Property
    {
        ...
        public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
            ...
            [Pid.TestItemList] = new Definition(Pid.TestItemList, Type.String, Use.ItemList, Group.Test, Access.System, Persistence.Persistent, "10000000001 10000000002", ""),
            [Pid.TestItemList1] = new Definition(Pid.TestItemList1, Type.String, Use.ItemList, Group.Test, Access.System, Persistence.Persistent, "10000000001 10000000002", ""),
            [Pid.TestItemList2] = new Definition(Pid.TestItemList2, Type.String, Use.ItemList, Group.Test, Access.System, Persistence.Persistent, "10000000001 10000000002", ""),
            [Pid.TestItemList3] = new Definition(Pid.TestItemList3, Type.String, Use.ItemList, Group.Test, Access.System, Persistence.Persistent, "10000000001 10000000002", ""),
