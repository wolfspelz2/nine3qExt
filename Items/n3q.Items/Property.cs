...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        [Pid.Unknown                               ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Unknown    , PropertyValue.Empty , "", ""),
        [Pid.FirstSystem                           ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , PropertyValue.Empty , "", ""),
        ...
        [Pid.FirstTest                             ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , PropertyValue.Empty , "", ""),
        ...
        [Pid.FirstGeneric                          ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , PropertyValue.Empty , "------------------------------------------------------", ""),
        [Pid.Name                                  ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.Generic   , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "Avatar", ""),
        ...
        [Pid.ImageUrl                              ] = new Definition(Storage.String  , Type.String          , Use.ImageUrl     , Group.Generic   , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "http://...", ""),
        [Pid.AnimationsUrl                         ] = new Definition(Storage.String  , Type.String          , Use.Url          , Group.Generic   , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "http://...", ""),
        ...
        [Pid.Partner                               ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Generic   , Access.System  , Persistence.Persistent , PropertyValue.Empty , "partner-id-t6t8ogzubh", "Id of the the external partner who manages the item."),
        ...
        [Pid.FirstAspect                           ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , PropertyValue.Empty , "------------------------------------------------------", ""),
        [Pid.TestGreetedAspect                     ] = new Definition(Storage.Bool    , Type.Bool            , Use.Aspect       , Group.Aspect    , Access.System  , Persistence.Persistent , PropertyValue.Empty , "true", "Item has Greeted test aspect"),
        [Pid.TestGreeterAspect                     ] = new Definition(Storage.Bool    , Type.Bool            , Use.Aspect       , Group.Aspect    , Access.System  , Persistence.Persistent , PropertyValue.Empty , "true", "Item has Greeter test aspect"),
        ...
        [Pid.PartnerAspect                         ] = new Definition(Storage.Bool    , Type.Bool            , Use.Aspect       , Group.Aspect    , Access.System  , Persistence.Persistent , PropertyValue.Empty , "true", "Item represents an external partner"),
        [Pid.ItemCapacityLimitAspect               ] = new Definition(Storage.Bool    , Type.Bool            , Use.Aspect       , Group.Aspect    , Access.System  , Persistence.Persistent , PropertyValue.Empty , "true", "Item is a container with capacity limit"),
        ...
        [Pid.FirstParameter                        ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Persistent , PropertyValue.Empty , "------------------------------------------------------", ""),
        [Pid.TestGreetedGetGreetingGreeter         ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "1", "Greeter item id"),
        [Pid.TestGreetedGetGreetingName            ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "World", "Greeted name"),
        [Pid.PartnerGenerateTokenSecret            ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "jzg76tiftvgg675ft", "Payload token secret"),
        ...
        //[Pid.SettingsSetInventoryCoordinatesLeft   ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Left position of the repository."),
        //[Pid.SettingsSetInventoryCoordinatesBottom ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Bottom distance of the repository."),
        //[Pid.SettingsSetInventoryCoordinatesWidth  ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Width of the repository."),
        //[Pid.SettingsSetInventoryCoordinatesHeight ] = new Definition(Storage.String  , Type.Int             , Use.Int          , Group.Parameter , Access.System  , Persistence.Transient  , PropertyValue.Empty , "100", "Height of the repository."),
        ...
        [Pid.ApplierApplyTo                        ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.Parameter , Access.System  , Persistence.Unknown    , PropertyValue.Empty , "ItemId", "Passive item of item action."),
        [Pid.FirstApp                              ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Fixed      , PropertyValue.Empty, "------------------------------------------------------", ""),
        [Pid.TestGreeterPrefix                     ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.App       , Access.System  , Persistence.Persistent , PropertyValue.Empty , "Hello ", "Greeting prefix"),
        [Pid.TestGreeterResult                     ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.App       , Access.System  , Persistence.Transient  , PropertyValue.Empty , "Hello World", "Greeting result stored by Greeter before return"),
        [Pid.TestGreetedResult                     ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.App       , Access.System  , Persistence.Transient  , PropertyValue.Empty , "Hello World", "Greeting result stored by Greeted"),
        [Pid.PartnerToken                          ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.App       , Access.System  , Persistence.Persistent , PropertyValue.Empty , "<base64-string>", "The external partner's secret token"),
        ...
        //[Pid.InventoryLeft                         ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "100", "Left position of the repository."),
        //[Pid.InventoryBottom                       ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "100", "Bottom distance of the repository."),
        //[Pid.InventoryWidth                        ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "100", "Width of the repository."),
        //[Pid.InventoryHeight                       ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "100", "Height of the repository."),
        ...
        [Pid.DocumentMaxLength                     ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "1000", "Max length of DocumentText property to be stored"),
        ...
        [Pid.WaterLevelMax                         ] = new Definition(Storage.Float   , Type.Float           , Use.Ccm          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "300", "Water level max."),
        [Pid.FirstUserAttribute                    ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Persistent , PropertyValue.Empty , "", ""),
        [Pid.LastProperty                          ] = new Definition(Storage.Unknown , Type.Unknown         , Use.Unknown      , Group.Unknown   , Access.System  , Persistence.Persistent , PropertyValue.Empty , "", ""),
