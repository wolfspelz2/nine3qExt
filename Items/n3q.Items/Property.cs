...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.RezzedDestination                     ] = new Definition(Storage.String  , Type.String          , Use.Url          , Group.App       , Access.Owner   , Persistence.Persistent , PropertyValue.Empty , "http://...", "Url of the page where the item was rezzed"),
        ...
        [Pid.RezableProxyTargetItem                ] = new Definition(Storage.String  , Type.String          , Use.Item         , Group.App       , Access.System  , Persistence.Persistent , PropertyValue.Empty , "ItemId", "Id of proxied item."),
        [Pid.RezableProxyDestination               ] = new Definition(Storage.String  , Type.String          , Use.Url          , Group.App       , Access.Owner   , Persistence.Persistent , PropertyValue.Empty , "http://...", "Url of the page where the proxied item was rezzed"),
        [Pid.RezableProxyTargetLabel               ] = new Definition(Storage.String  , Type.String          , Use.String       , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "WaterBottle", "Label of the proxied item. Will be translated."),
