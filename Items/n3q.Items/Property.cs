...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.IframeUrl                             ] = new Definition(Storage.String  , Type.String          , Use.Url          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "IFrameUrl", "TODO."),
        [Pid.IframeWidth                           ] = new Definition(Storage.Int     , Type.Int             , Use.String       , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "IFrameWidth", "TODO."),
        [Pid.IframeHeight                          ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "IFrameHeight", "TODO."),
        [Pid.IframeResizeable                      ] = new Definition(Storage.Bool    , Type.Bool            , Use.Bool         , Group.App       , Access.Public  , Persistence.Persistent , PropertyValue.Empty , "IFrameResizable", "TODO."),
