...
#pragma warning disable format
    public static readonly Dictionary<Pid, Definition> Definitions = new Dictionary<Pid, Definition> {
        ...
        [Pid.ContainerX                     ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , "100", "X position in inventory."),
        [Pid.ContainerY                     ] = new Definition(Storage.Int     , Type.Int             , Use.Int          , Group.App       , Access.Public  , Persistence.Persistent , "100", "Y position in inventory."),
